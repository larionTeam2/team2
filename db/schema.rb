...
ActiveRecord::Schema.define(version: 20180404074448) do
  ...
  create_table "admins", force: :cascade do |t|
    ...
    t.index ["reset_password_token"], name: "i_admins_reset_password_token", unique: true
  end
  ...
  create_table "comments", force: :cascade do |t|
    t.string "commenter"
    t.text "body"
    t.integer "picture_id", limit: 19, precision: 19
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
